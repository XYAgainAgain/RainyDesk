...
import type { BackgroundRainConfig } from '../../types/webgl';
...
interface UniformLocations {
  ...
  absoluteTime: WebGLUniformLocation | null;
  intensity: WebGLUniformLocation | null;
  wind: WebGLUniformLocation | null;
  resolution: WebGLUniformLocation | null;
  layerCount: WebGLUniformLocation | null;
  speed: WebGLUniformLocation | null;
  colorTint: WebGLUniformLocation | null;
  rainbowMode: WebGLUniformLocation | null;
  rainbowSpeed: WebGLUniformLocation | null;
  reverseGravity: WebGLUniformLocation | null;
}
...
class BackgroundRainShader {
  ...
  private _lastLoggedConfig = '';
  private _configLogTimer: ReturnType<typeof setTimeout> | undefined;
  private _lastLogTime: number | undefined;

  private config: Required<BackgroundRainConfig> = {
    intensity: 0.5,
    wind: 0.0,
    layerCount: 3,
    speed: 1.0,
  ...
  updateConfig(config: Partial<BackgroundRainConfig>): void {
  ...
  getConfig(): Required<BackgroundRainConfig> {
    return { ...this.config };
  }

  /* Links to particle intensity */

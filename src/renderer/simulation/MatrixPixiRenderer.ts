import { Application, Assets, Container, BitmapText } from 'pixi.js';
...
export class MatrixPixiRenderer {
  ...
  private async initBitmapFont(): Promise<void> {
    ...
    // Load pre-built BMFont atlas (generated by .dev/tools/generate-matrix-font.html)
    await Assets.load('fonts/MatrixBitmapFont.fnt');
    console.log('[Matrix] Pre-built BitmapFont loaded');
